...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post abilities_url, params: { ability: { ability_id: @ability.ability_id, generation: @ability.generation, name: @ability.name } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { ability_id: @ability.ability_id, generation: @ability.generation, name: @ability.name } }
