...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { generation: @type.generation, name: @type.name, type_id: @type.type_id } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { generation: @type.generation, name: @type.name, type_id: @type.type_id } }
